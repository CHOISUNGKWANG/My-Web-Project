		 ...
		 <form action="search.do" method="post" name="searchForm">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4" style="float: left;"><a href="main.do">자유 게시판☆</a></h4>
				<div class="fw-bold py-3 mb-4" style="float: right;">
					<a href="insertBoard.jsp">
						<button id="insertBoard" class="btn rounded-pill btn-outline-primary">글 작성하기</button>
					</a>
				</div>
              ...
              <h5 class="card-header">검색결과가 없습니다.</h5>
              </c:when>
              <c:otherwise>
