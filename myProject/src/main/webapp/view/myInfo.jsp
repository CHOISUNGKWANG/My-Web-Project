  ...
  <body>
		 ...
		 <form action="search.do" method="post" name="searchForm">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      ...
                      <small class="text-muted float-end"><a href="deleteMember.do?mid=${mdata.mid}" id="deleteMember">회원탈퇴</a></small>
                    </div>
                    <div class="card-body">
                      <form>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="basic-default-name" value="${mdata.mid}" readonly="readonly"/>
                          </div>
                        </div>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-company">Nickname</label>
                          <div class="col-sm-10">
                            <input
                              type="text"
                              class="form-control"
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <input
                                ...
                                readonly="readonly"
                              />
                              <span class="input-group-text" id="basic-default-email2"><a href="pwUpdate.jsp">수정</a><span>
                            </div>
                          </div>
                        </div>
                        <div class="row mb-3">
              ...
              <c:choose>
              <c:when test="${fn:length(bdatas)==0}">
              <h5 class="card-header">내 게시글이 없습니다.</h5>
              </c:when>
              <c:otherwise>
              	<h5 class="card-header">내 게시글</h5>
                <div class="table-responsive text-nowrap">
                  <table class="table table-hover">
                    ...
                    <c:forEach var="v" items="${bdatas}">
                    	<tr>
	                        <td>${v.bid}</td>
	                        <td><a href="detail.do?bid=${v.bid}&mid=${mid}">${v.btitle}</a></td>
	                        <td>${v.mnick}</td>
	                        <td>${v.bdate}</td>
	                        <td>${v.bhits}</td>
	                        <td>${v.blike}</td>
   ...
   <script type="text/javascript">
		$("#deleteMember").on("click", function() {
			if (confirm("탈퇴 후 회원정보 및 게시글, 댓글 정보가 모두 삭제됩니다.\n삭제된 데이터는 복구되지 않습니다.\n회원탈퇴를 진행하시겠습니까?") == false) {
				return false;
			}
		});
	</script>
