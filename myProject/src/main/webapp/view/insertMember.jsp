            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="main.do" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder" style="text-transform: uppercase;">LOLC</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2" style="text-align: center;">회원가입 🚀</h4>

              <form id="formAuthentication" class="mb-3" action="insertMember.do" method="POST">
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="email" name="memail" placeholder="이메일" required="required" />
                </div>
                <button id="sendEmail" class="btn btn-outline-primary d-grid w-100" style="margin-bottom: 8px;">인증코드 전송</button>
                <div class="mb-3">
                  <label for="email" class="form-label">code</label>
                  <input type="text" class="form-control" id="emailCheck" placeholder="인증코드" style="margin-bottom: 8px;" disabled="disabled"/>
                  <span id="codeCheck"></span>
                </div>

                <div class="mb-3">
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="terms-conditions" name="terms" required="required" />
                    <label class="form-check-label" for="terms-conditions">
                      <a href="javascript:policy_service();">이용약관</a><span>에 모두 동의합니다.</span>
                    </label>
                  </div>
                </div>
                <button id="register" type="submit" class="btn btn-primary d-grid w-100">가입하기</button>
              </form>
