              ...
              <div class="row">
                <div class="col-xl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form action="updateBoard.do?bid=${bdata.bid}" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-fullname">작성자</label>
                          <input type="text" name="mnick" class="form-control" id="basic-default-fullname" value="${mnick}" readonly="readonly"/>
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-title">제목</label>
                          <input type="text" name="btitle" class="form-control" id="basic-default-title" value="${bdata.btitle}" placeholder="제목을 입력해주세요." required="required"/>
                        </div>
                        <div id="imgContainer" class="mb-3">
                          <label class="form-label" for="basic-default-company">이미지 업로드</label>
                          <input type="file" name="bimg" accept="image/*" class="form-control" id="basic-default-company" onchange="setThumbnail(event);" style="margin-bottom: 16px;" />
                        </div>
                        <div class="mb-3">
    ...
    <script async defer src="https://buttons.github.io/buttons.js"></script>
       ...
       <script>
    	var img = document.createElement("img");
  		img.setAttribute("src", "${pageContext.request.contextPath}/file/${bdata.bimg}");
  		document.querySelector("div#imgContainer").appendChild(img);
  		// 이미지 업로드
  		function setThumbnail(event) {
  			var reader = new FileReader();
  			reader.onload = function(event) {
  				var img = document.querySelector("div#imgContainer img");
