  ...
  <body>
                    ...
                    <div class="card-body">
                      ...
                      <input type="hidden" name="mid" value="${mid}">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" name="btitle" class="form-control" id="basic-default-title" placeholder="제목을 입력해주세요." required="required""/>
                        </div>
                        <div id="imgContainer" class="mb-3">
                          <label class="form-label" for="basic-default-company">이미지 업로드</label>
                          <input type="file" name="bimg" accept="image/*" class="form-control img-fluid" id="basic-default-company" onchange="setThumbnail(event);" style="margin-bottom: 16px;" />
                        </div>
                        <div class="mb-3">
    ...
    <script async defer src="https://buttons.github.io/buttons.js"></script>
      ...
      function setThumbnail(event) {
         if (document.querySelector("div#imgContainer img") == null) {
